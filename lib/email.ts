        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px;">
                  ...
                  <td style="padding: 0 32px;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 12px;">
                      <tr><td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0;">
                        <table width="100%"><tr>
                          <td style="color: #64748b; font-size: 13px; text-transform: uppercase;">Service</td>
                          <td align="right" style="color: #0f172a; font-size: 15px; font-weight: 600;">${serviceName}</td>
                        </tr></table>
                      </td></tr>
                      <tr><td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0;">
                        <table width="100%"><tr>
                          <td style="color: #64748b; font-size: 13px; text-transform: uppercase;">Specialist</td>
                          <td align="right" style="color: #0f172a; font-size: 15px; font-weight: 600;">${staffName}</td>
                        </tr></table>
                      </td></tr>
                      <tr><td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0;">
                        <table width="100%"><tr>
                          <td style="color: #64748b; font-size: 13px; text-transform: uppercase;">Date</td>
                          <td align="right" style="color: #0f172a; font-size: 15px; font-weight: 600;">${formattedDate}</td>
                        </tr></table>
                      </td></tr>
                      <tr><td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0;">
                        <table width="100%"><tr>
                          <td style="color: #64748b; font-size: 13px; text-transform: uppercase;">Time</td>
                          <td align="right" style="color: #6366f1; font-size: 15px; font-weight: 700;">${appointmentTime} (${duration} min)</td>
                        </tr></table>
                      </td></tr>
                      <tr><td style="padding: 16px 20px;">
                        <table width="100%"><tr>
                          <td style="color: #64748b; font-size: 13px; text-transform: uppercase;">Reference</td>
          ...
          <tr>
            <td style="padding: 24px; text-align: center;">
              <p style="color: #64748b; font-size: 12px; margin: 0;">Need to reschedule? Click "Manage Booking" above.</p>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden;">
                ...
                <tr>
                  <td style="background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); padding: 32px; text-align: center;">
                    ...
                    <h1 style="color: #ffffff; font-size: 24px; font-weight: 700; margin: 0;">Booking Cancelled</h1>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 32px 32px 24px;">
                    <p style="color: #334155; font-size: 16px; margin: 0;">
                      Hi <strong>${customerName}</strong>, your appointment has been cancelled.
                    </p>
                  </td>
                </tr>
                  ...
                  <td style="padding: 0 32px;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border-radius: 12px;">
                      ...
                      <tr><td style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0;">
                        <table width="100%"><tr>
                          <td style="color: #64748b; font-size: 13px; text-transform: uppercase;">Time</td>
                          <td align="right" style="color: #64748b; font-size: 15px; font-weight: 600;">${appointmentTime}</td>
                        </tr></table>
                      </td></tr>
                      <tr><td style="padding: 16px 20px;">
                        <table width="100%"><tr>
                ...
                <tr>
                  <td style="padding: 32px; text-align: center;">
                    <a href="https://hera-booking.vercel.app/booking" style="display: inline-block; background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 10px; font-size: 15px; font-weight: 600;">
                      Book Again
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding: 24px; text-align: center;">
              <p style="color: #64748b; font-size: 12px; margin: 0;">We hope to see you again soon!</p>
            </td>
          </tr>
        </table>
      </td>
